...
class User extends CI_Controller {
    ...
    public function users($argv = '', $argv1 = '', $argv2 = '', $argv3 = '')
    {
        if($argv == ''){
            ...
            $pageData['url'] = base_url().'user/users/list';
    ...
    public function departement($argv = '', $argv1 = '', $argv2 = '', $argv3 = '')
    {
        if($argv == ''){
            ...
            #request ajax list data
            $pageData['url'] = base_url().'user/departement/list';
    ...
    public function boards($argv = '', $argv1 = '', $argv2 = '', $argv3 = '')
    {
        if($argv == ''){
            ...
            #request ajax list data
            $pageData['url'] = base_url().'user/boards/list';
    ...
    public function label($argv = '', $argv1 = '', $argv2 = '', $argv3 = '')
    {
        if($argv == ''){
            ...
            #request ajax list data
            $pageData['url'] = base_url().'user/label/list';
    ...
    public function workspaces($argv = '', $argv1 = '', $argv2 = '', $argv3 = ''){
        ...
        if($argv == ''){
            $penggunaid = decrypt($this->session->userdata('pengguna_id'));
            $workspaces = $this->Md_workspace->getAllworkspace();
            $haveWorkspace=[];
            if($workspaces){
                foreach($workspaces as $w){
                    $dtMember = $this->Md_member->getMemberByWorkspaceidAndPenggunaId($w->workspace_id, $penggunaid);
                    if($dtMember){
                        $haveWorkspace[$w->workspace_id]=true;
                    }else{
                        $haveWorkspace[$w->workspace_id]=false;
                    }
                }
            }
            $pageData['myWorkspace'] = $haveWorkspace;
            $pageData['workspaces'] = $workspaces;
    ...
    public function kanbanboard($argv = '', $argv1 = '', $argv2 = '', $argv3 = ''){
        if($argv == 'get'){
            ...
            $access = $this->Md_member->getMemberByWorkspaceidAndPenggunaId($workspace_id, $penggunaid);
            $pageData['allowAccess'] = $access ? true : false;
