                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <button type="button" class="btn btn-warning btn-block btn-flat" onclick="addData()"><i class="fa fa-plus"></i> Add Board </button>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
                ...
                <form action="#" id="form">
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="board" placeholder="nama board">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function addData(){
        resetForm();
        $(".modal-title").html('Add Data Board');
    ...
    function save(){
        ...
        var id = $('[name="board_id"]').val();
        var url = id ==  '' ? "<?=base_url().'spadmin/boards/add'?>" : "<?=base_url().'spadmin/boards/update'?>";
    ...
    function edit(id){
        resetForm();
        $(".modal-title").html('Edit Data Board');
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('spadmin/boards/edit')?>/" + id,
            dataType : "JSON",
            success: function(data){
              $('#modal_add').modal('show');
    ...
    function hapus(id){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type : "GET",
                    url  : "<?php echo base_url('spadmin/boards/hapus')?>/" + id,
                    dataType : "JSON",
                    success: function(data){
                        if(data.data){
                            reload_table();
