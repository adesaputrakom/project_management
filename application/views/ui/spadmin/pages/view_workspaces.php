                                                    ...
                                                    <div class="card bg-light d-flex flex-fill">
                                                        ...
                                                        <div class="card-footer" style="background-color: '.$w->color.';">
                                                            <div class="text-right">
                                                                <a href="javascript:edit(\''.encrypt($w->workspace_id).'\');" class="btn btn-sm btn-default text-primary" title="edit">
                                                                    <i class="fas fa-pen"></i> Edit
                                                                </a>
                                                                <a href="'.base_url().'spadmin/kanbanboard/get/'.encrypt($w->workspace_id).'" class="btn btn-sm btn-default text-primary" title="view">
            ...
            <div class="modal-body" style="padding: 50px;">
                ...
                <form action="#" id="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Unit Kerja<font class="text-danger">*</font></label>
  ...
  <script type="text/javascript">
        ...
        function getdataMember(id){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('spadmin/workspaces/addMember')?>/" + id,
                dataType : "JSON",
        ...
        function getTeam(){
            ...
            if(departementid){
                ...
                $.ajax({
                    type : "GET",
                    url  : "<?php echo base_url('spadmin/workspaces/addTeamDepartement')?>/" + departementid,
                    dataType : "JSON",
                    success: function(data){
                        if(data.data){
        ...
        function save(){
            ...
            var url = id ==  '' ? "<?=base_url().'spadmin/workspaces/add'?>" : "<?=base_url().'spadmin/workspaces/update'?>";
        ...
        function edit(id){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('spadmin/workspaces/edit')?>/" + id,
                dataType : "JSON",
                success: function(data){
                    $('#modal_add').modal({backdrop: 'static', keyboard: false})  //Nonaktifkan klik di luar area modal bootstrap untuk menutup modal
                    $('#modal_add').modal('show');
                    ...
                    $('[name="unitkerja_id"] option[value="'+data.unitkerja_id+'"]').attr('selected', 'selected');
        ...
        function hapus(id){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type : "GET",
                        url  : "<?php echo base_url('spadmin/workspaces/hapus')?>/" + id,
                        dataType : "JSON",
                        success: function(data){
                            if(data.data){
                                Swal.fire({
