                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-10">
                                    <h3 class="card-title">Management Label</h3>
                                </div>
                                <div class="col-2">
                                    <button type="button" class="btn btn-warning btn-block btn-flat" onclick="addData()"><i class="fa fa-plus"></i> Add Label </button>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
                ...
                <form action="#" id="form">
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="label" placeholder="nama label">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function addData(){
        resetForm();
        $(".modal-title").html('Add Data Label');
    ...
    function save(){
        ...
        var id = $('[name="label_id"]').val();
        var url = id ==  '' ? "<?=base_url().'spadmin/label/add'?>" : "<?=base_url().'spadmin/label/update'?>";
    ...
    function edit(id){
        resetForm();
        $(".modal-title").html('Edit Data Label');
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('spadmin/label/edit')?>/" + id,
            dataType : "JSON",
            success: function(data){
              $('#modal_add').modal('show');
    ...
    function hapus(id){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type : "GET",
                    url  : "<?php echo base_url('spadmin/label/hapus')?>/" + id,
                    dataType : "JSON",
                    success: function(data){
                        if(data.data){
                            reload_table();
