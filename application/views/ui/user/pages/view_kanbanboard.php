                ...
                <div class="modal-body" style="padding: 50px;">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                            ...
                            <div class="form-group">
                                <label style="font-weight : unset"> Deskripsi : </label>
                                <textarea class="form-control text-muted" disabled rows="5" name="deskripsi" placeholder="Deskripsi" onfocusout="saveDeskripsi();"></textarea> <!-- deskripsi -->
                            </div>

                            <div class="form-group">
                                <label style="font-weight : unset"> Duedate : </label>
                                <div class="input-group datetime" id="reservationdatetime" data-target-input="nearest">
                                    <input type="text" disabled class="form-control datetimepicker-input" data-target="#reservationdatetime" name="duedate" placeholder="duedate" onfocusout="saveDuedate();">
                                    <div class="input-group-append" data-target="#reservationdatetime" data-toggle="datetimepicker">
                                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function saveCard(){
        ...
        $.ajax({
            url : "<?=base_url()?>user/kanbanboard/saveCard",
            type: "POST",
    ...
    function updateCard(card_id,board_id){
        ...
        $.ajax({
            url : "<?=base_url()?>user/kanbanboard/updateCard",
            type: "GET",
            data:{
                card_id : card_id,
                board_id : board_id
    ...
    function showCard(id=''){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('user/kanbanboard/showCard')?>/" + id,
            dataType : "JSON",
            success: function(data){
                if(data.status == true){
                    $('[name="card_id"]').val(`${id}`);
    ...
    function saveItem(){
        ...
        $.ajax({
            url : "<?=base_url()?>user/kanbanboard/"+url,
            type: "POST",
            data: form_data, //this is formData
            processData:false,
            contentType:false,
    ...
    function editItem(id){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('user/kanbanboard/editItem')?>/"+id,
            dataType : "JSON",
            success: function(data){
                if(data.data){
    ...
    function hapusItem(id=''){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type : "GET",
                    url  : "<?php echo base_url('user/kanbanboard/hapusItem')?>/" + id,
                    dataType : "JSON",
                    success: function(data){
                        if(data.data){
                            $(`.list_${id}`).remove();
    ...
    function checklistItem(id, finish=''){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('user/kanbanboard/checklistItem')?>",
            data : {
                carddetail_id : id,
                finish        : finishVal
            },
    ...
    function saveDeskripsi(){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('user/kanbanboard/card/saveDeskripsi')?>",
            data : {
                cardid : cardID,
                deskripsi : deskripsi
            },
    ...
    function saveDuedate(){
        ...
        if(duedate){
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('user/kanbanboard/card/saveDuedate')?>",
                data : {
                    cardid : cardID,
                    duedate : duedate
                },
    ...
    function deleteAttachment(id){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type : "GET",
                    url  : "<?php echo base_url('user/kanbanboard/card/deleteFile')?>/" + id,
                    dataType : "JSON",
                    success: function(data){
                        if(data.data){
                            $(`.lampiran_${id}`).remove();
    ...
    function join(){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('user/kanbanboard/card/joinTeam')?>",
            data : {
                card_id : cardID
            },
            dataType : "JSON",
    ...
    function setLabel(labelid){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('user/kanbanboard/card/setLabel')?>",
            data : {
                card_id : cardID,
                label_id : labelid
            },
    ...
    function deleteCard(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type : "GET",
                    url  : "<?php echo base_url('user/kanbanboard/card/deleteCard')?>/" + cardID,
                    dataType : "JSON",
                    success: function(data){
                        if(data.data){
                            toastr.success('Success', data.message, {timeOut: 1200});
    ...
    function reload_kanbanboard(wp_id){
        ...
        $.ajax({
            url: "<?php echo base_url() . 'user/kanbanboard/getData' ?>/" + wp_id +'/'+ unitkerjaid,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                if(data.data){
    ...
    function editnamacard(id){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('user/kanbanboard/card/getCard')?>/"+id,
            dataType : "JSON",
            success: function(data){
                if(data.data){
                    $('.namacard').hide();
    ...
    function updateNamacard(){
        ...
        if(cardname != ''){
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('user/kanbanboard/card/updateNamaCard')?>",
                data : {
                    cardid : cardID,
                    namacard : cardname,
                },
...
<script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", function(t) {
        ...
        $('#sending').on("click", function(e){
            ...
            if(komentar){
                $.ajax({
                    url : "<?=base_url()?>user/kanbanboard/sendcomment",
                    type: "POST",
                    data: form_data, //this is formData
                    processData:false,
                    contentType:false,
        ...
        $('#fileupload').on("change", function(e){
            ...
            if(typeof $(this)[0].files[0] !== 'undefined'){
                ...
                if(size > 5300){
                    ...
                    $.ajax({
                        url  : "<?php echo base_url('user/kanbanboard/card/saveFile')?>",
                        type : "POST",
                        processData: false,
                        contentType: false,
                        cache: false,
